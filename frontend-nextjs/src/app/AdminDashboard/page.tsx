...
import { LogOut, Users, BookOpen, Settings, BarChart3 } from 'lucide-react';
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-blue-900/30 border border-blue-700/50 rounded-lg p-6 mb-8">
          ...
          <p className="text-gray-300">
            Manage your platform, users, and courses from this dashboard.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-black/30 backdrop-blur-md border border-blue-800/30 rounded-xl p-6 hover:bg-black/40 transition-all duration-300">
            ...
            <p className="text-gray-300 mb-4">View, edit, and manage user accounts</p>
          ...
          <div className="bg-black/30 backdrop-blur-md border border-blue-800/30 rounded-xl p-6 hover:bg-black/40 transition-all duration-300">
            ...
            <p className="text-gray-300 mb-4">Create, edit, and organize courses</p>
            <button className="text-orange-500 hover:text-orange-400 font-medium">
              Manage Courses →
            </button>
          </div>
          ...
          <div className="bg-black/30 backdrop-blur-md border border-blue-800/30 rounded-xl p-6 hover:bg-black/40 transition-all duration-300">
            ...
            <p className="text-gray-300 mb-4">View platform analytics and reports</p>
            <button className="text-orange-500 hover:text-orange-400 font-medium">
              View Analytics →
            </button>
          </div>
